...
const tempPost = [
	{
		...
		description:
			"Dive into full-stack development with this comprehensive course on React for frontend and Node.js for the backend.",
	},
	{
		postId: 2,
		...
		image: "https://via.placeholder.com/400x200",
		description:
			"Learn how to deploy scalable applications and manage your infrastructure with AWS cloud services.",
	},
